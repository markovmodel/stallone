...
public class TransitionMatrixSamplerRevDeltaG extends TransitionMatrixSamplerAbstract
{
    ...
    public TransitionMatrixSamplerRevDeltaG( IDoubleArray counts, IDeltaGDistribution _deltaG )
    {
        super( counts );
        deltaG = _deltaG;
    }

    public TransitionMatrixSamplerRevDeltaG( IDoubleArray counts, IDeltaGDistribution _deltaG, IDoubleArray Tinit )
    {
        super( counts, Tinit );
        deltaG = _deltaG;
    }
